...
our %config = (
  ...
  CPPFLAGS => [ "-DANDROID -D__ANDROID_API__=21 -I/home/soichi/.buildozer/android/platform/android-ndk-r19c/sysroot/usr/include/arm-linux-androideabi -I/home/soichi/Documents/KivyMD_proyects/Cotizador/screens/.buildozer/android/platform/build-armeabi-v7a/build/python-installs/Cotizador_RAS/include/python3.8" ],
  CPPINCLUDES => [  ],
  ...
  LDFLAGS => [ "  -L/home/soichi/Documents/KivyMD_proyects/Cotizador/screens/.buildozer/android/platform/build-armeabi-v7a/build/libs_collections/Cotizador_RAS/armeabi-v7a" ],
  LDLIBS => [ "-lm" ],
  PERL => "/usr/bin/perl",
  RANLIB => ":",
  RC => "windres",
